 ...
 * @since 1.0
 */
public class GinSupportGwtTestSuite extends GWTTestSuite {
  /**
  ...
  public static Test suite() {
    GinSupportGwtTestSuite suite = new GinSupportGwtTestSuite();
  ...
  /**
   * Construct a new Gin Support GWT Test Suite.
   * <p>
   * This constructor is declared <code>private</code> to prevent external
   * instantiation.
   */
  private GinSupportGwtTestSuite() {
    super("Gin Support GWT Test Suite.");
  }
}
